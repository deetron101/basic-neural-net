    ...
    <nav class="bg-white border-b border-gray-200">
        ...
        <div class="flex justify-between h-16">
          <div class="flex">
            ...
            <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
              ...
              <router-link to="/two-layer" class="border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium">
                Two Layer
              </router-link>
            </div>
          </div>
      ...
      <div class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
          ...
          <router-link to="/perceptron" class="bg-indigo-50 border-indigo-500 text-indigo-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
            Perceptron
          </router-link>
          <router-link to="/two-layer" class="border-transparent text-gray-600 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-800 block pl-3 pr-4 py-2 border-l-4 text-base font-medium">
            Two Layer
          </router-link>
        </div>
      </div>
